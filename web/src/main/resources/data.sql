...
(
    ...
    CONSTRAINT PK_WEEKENDS PRIMARY KEY (WEEKEND_ID)
);
...
(
    ...
    WEEKEND_ID     BIGINT                                  NOT NULL,
    EXCHANGE_RATE_VALUE  DECIMAL(7, 2)                           NOT NULL,
    CONSTRAINT PK_EXCHANGE_RATES PRIMARY KEY (EXCHANGE_RATE_ID),
    CONSTRAINT FK_WEEKENDS FOREIGN KEY (WEEKEND_ID) REFERENCES WEEKENDS (WEEKEND_ID)
);
